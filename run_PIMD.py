...
# mysim = Simulation( dt=100/2.4188843265857, L=11.3E+2 , temp=T, Nsteps=1000000, 
#                        mass=1, R=np.zeros( (1,3) ),beads=64, ftype="Harm", 
#                        kind=["Ar"], printfreq=100, fac=1,thermo_type="Langevin")
